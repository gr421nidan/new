...
export const formAuthStyles = `${flexCol} border-3 border-purple-lighter-opacity px-[76px] py-[40px] gap-[62px] w-[626px] rounded-[50px] bg-gradient-purple backdrop-blur-[60px]`;
