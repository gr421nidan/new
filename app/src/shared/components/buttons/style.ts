    ...
    "cursor-pointer  rounded-[20px] transition-all duration-200 outline-none",
    {
        variants: {
            variant: {
                ...
                icon: "text-purple hover:drop-shadow-[0_0_5px_var(--color-purple)] dark:text-purple-light dark:hover:text-purple dark:hover:drop-shadow-[0_0_5px_var(--color-purple)]",
